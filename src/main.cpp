...
// drive motors
pros::Motor lF(12, pros::E_MOTOR_GEARSET_06); // left front motor. port 12
...
lemlib::Drivetrain drivetrain(&leftMotors, // left motor group
                              ...
                              2 // chase power is 2. If we had traction wheels, it would have been 8, tune later
);

//Modify when wheels are on
//Odometry Tracking Wheels Object, y_enc is the wheel on the y axis(front and back), x is on x axis(side to side)
// left tracking wheel encoder
pros::ADIEncoder y_enc('A', 'B', true); // ports A and B, reversed
// back tracking wheel encoder
pros::ADIEncoder x_enc('C', 'D', false); // ports C and D, not reversed
// uses "left_enc" as the encoder. Old 2.75" wheel, 4.3" left of the tracking center, 2:1 gear ratio
lemlib::TrackingWheel y_tracking_wheel(&y_enc, lemlib::Omniwheel::OLD_275, -4.3);
// uses "back_enc" as the encoder. Old 2.75" wheel, 4.5" back of the tracking center, 1:1 gear ratio (default)
lemlib::TrackingWheel x_tracking_wheel(&x_enc, lemlib::Omniwheel::OLD_275, -4.5);

// inertial sensor
pros::Imu inertial_sensor(2); // port 2

// odometry struct
lemlib::OdomSensors sensors(&y_tracking_wheel, // vertical tracking wheel 1
                            nullptr, //vertical tracking wheel 2, don't have one
